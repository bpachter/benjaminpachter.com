...
These days I am most interested in studying complex options trading strategies and automating these through brokerage APIs. My favorite is IBKR, as it is easy to set up a paper trading account that can be directly connected to my TradingView Pine scripts for easy and transparent backtesting.
...
More recently, I have been experimenting with shaping Federal Reserve macroeconomic data (FRED) for monitoring the economic health of the global economy. Particularly, I have employed the FRED, FDIC, and Census APIs to easily shape together unraveling macro and micro trends.
